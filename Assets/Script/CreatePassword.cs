...
public class CreatePassword : MonoBehaviour
{
    ...
    private string psw_path;
    private const string psw_fileName = "psw";
    private static string psw_finalPath;
    ...
    public CreatePassword()
    {
        ...
        if (psw_finalPath == null)
        {
            psw_path = Application.dataPath;
            psw_finalPath = psw_path + "/" + psw_fileName;
        }
    }

    public string Create()
    {
        return _Create(GetPSW());
    }

    public string GetPSW()
    {
        if (File.Exists(psw_finalPath))
        {
            StreamReader sr = File.OpenText(psw_finalPath);
